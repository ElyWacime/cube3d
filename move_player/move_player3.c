...
/*   Updated: 2025/02/15 17:50:56 by skamroun         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	check_if_wall_up_movement_1(t_var *var, t_point new_position)
{
	...
	{
		if (var->map[px_to_map_grid(new_position.y)][px_to_map_grid(new_position.x
				- 1)] != '1'
			&& var->map[px_to_map_grid(new_position.y)][px_to_map_grid(new_position.x
				- 1)] != 'P')
			return (1);
	}
