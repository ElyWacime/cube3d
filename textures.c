...
size_t east_textures(t_var *var, t_ray_wall *ra_wl, int ofsx)
{
    ...
    int r = (var->east->pixels[ra_wl->pix + 0]) << 24;
    int g = (var->east->pixels[ra_wl->pix + 1]) << 16;
    int b =  (var->east->pixels[ra_wl->pix + 2]) << 8;
    int o = var->east->pixels[ra_wl->pix + 3];
    return   r|  g| b|  o;
}
...
size_t north_textures(t_var *var, t_ray_wall *ra_wl, int ofsx)
{
    ...
    int r = (var->north->pixels[ra_wl->pix + 0]) << 24;
    int g = (var->north->pixels[ra_wl->pix + 1]) << 16;
    int b =  (var->north->pixels[ra_wl->pix + 2]) << 8;
    int o = var->north->pixels[ra_wl->pix + 3];
    return   r|  g| b|  o;
}
...
size_t west_textures(t_var *var, t_ray_wall *ra_wl, int ofsx)
{
    ...
    int r = (var->west->pixels[ra_wl->pix + 0]) << 24;
    int g = (var->west->pixels[ra_wl->pix + 1]) << 16;
    int b =  (var->west->pixels[ra_wl->pix + 2]) << 8;
    int o = var->west->pixels[ra_wl->pix + 3];
    return   r|  g| b|  o;
...
size_t south_textures(t_var *var, t_ray_wall *ra_wl, int ofsx)
{
    ...
    int r = (var->south->pixels[ra_wl->pix + 0]) << 24;
    int g = (var->south->pixels[ra_wl->pix + 1]) << 16;
    int b =  (var->south->pixels[ra_wl->pix + 2]) << 8;
    int o = var->south->pixels[ra_wl->pix + 3];
    return   r|  g| b|  o;
