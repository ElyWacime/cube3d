...
size_t east_textures(t_var *var, t_ray_wall *ra_wl, int ofsx)
{
    ...
    if (ra_wl->pix >= var->east->height *var->east->width * 4)
        return 0xFFFFFF00;
...
size_t north_textures(t_var *var, t_ray_wall *ra_wl, int ofsx)
{
    ...
    if (ra_wl->pix >= var->north->height *var->north->width * 4)
        return 0xFFFFFF00;
...
size_t west_textures(t_var *var, t_ray_wall *ra_wl, int ofsx)
{
    ...
    if (ra_wl->pix >= var->west->height *var->west->width * 4)
        return 0xFFFFFF00;
...
size_t south_textures(t_var *var, t_ray_wall *ra_wl, int ofsx)
{
    ...
    if (ra_wl->pix >= var->south->height *var->south->width * 4)
        return 0xFFFFFF00;
